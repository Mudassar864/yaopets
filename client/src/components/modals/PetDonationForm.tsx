...
export default function PetDonationForm({ open, onOpenChange, onSuccess }: PetDonationFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Garantir que o campo content esteja presente
      const description = formData.get('petDescription') as string;
      if (!description) {
      ...
      // Usar description diretamente como content
      formData.append('content', formData.get('petDescription') as string || 'Pet para adoção');
      ...
      toast({
        ...
        description: 'Seu pet foi cadastrado para doação.',
      });
